...
class OsMail:
    ...
    def _render_email_template_teacher_sub_request(self, template_content, classes_otc_sub_avail_id):
        """
    ...
    def render_email_template(self,
        ...
        if email_template == 'order_received':
            ...
            content = self._render_email_template_teacher_sub_request(template_content, classes_otc_sub_avail_id)
